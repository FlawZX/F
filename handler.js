...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '*ғɪᴛᴜʀ ᴋʜᴜsᴜs ᴅᴇᴠᴇʟᴏᴘᴇʀ*',
        owner: 'ғɪᴛᴜʀ ᴋʜᴜsᴜs ᴏᴡɴᴇʀ',
        mods: '*ғɪᴛᴜʀ ᴋʜᴜsᴜs ᴍᴏᴅᴇʀᴀᴛᴏʀ ʙᴏᴛ',
        premium: '*ғɪᴛᴜʀ ᴋʜᴜsᴜs ᴍᴇᴍʙᴇʀ ᴘʀᴇᴍɪᴜᴍ*',
        group: 'ғɪᴛᴜʀ ᴋʜᴜsᴜs ᴅɪ ɢʀᴜᴘ',
        private: 'ʜᴀɴʏᴀ ᴅᴀᴘᴀᴛ ᴅɪ ɢᴜɴᴀᴋᴀɴ ᴅɪ ᴘʀɪᴠᴀᴛᴇ ᴍᴇssᴀɢᴇ',
        admin: 'ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ᴋʜᴜsᴜs ᴀᴅᴍɪɴ ɢʀᴜᴘ',
